document.addEventListener("DOMContentLoaded", () => {
  ...
  password.addEventListener("input", (e) => {
    ...
    const existingIndicator =
      password.parentNode.querySelector(".password-strength");
  ...
  username.addEventListener("input", (e) => {
    ...
    const existingIndicator = username.parentNode.querySelector(
    ...
    if (validateForm()) {
      ...
      setTimeout(() => {
        ...
        const accountTypeText =
          currentAccountType === "business" ? "Business" : "Personal";
        showMessage(
      ...
      if (userData.accountType) {
        ...
        accountTypes.forEach((type) => {
          type.classList.toggle(
            "active",
            type.dataset.type === currentAccountType
          );
        });
